...
class Marker(genpy.Message):
  _md5sum = "292ccfe6c002a8eb27e66aaee756e448"
...
float64 w
"""
  __slots__ = ['header','id','pose','confidence','angleX']
  _slot_types = ['std_msgs/Header','uint32','geometry_msgs/PoseWithCovariance','float64','float64']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,id,pose,confidence,angleX
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2d().pack(_x.confidence, _x.angleX))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.confidence, _x.angleX,) = _get_struct_2d().unpack(str[start:end])
      return self
